...
export const optimizeBuild = () => ({
    optimization: {
        ...
        // ? эта настройка зависит от providedExports и usedExports
        // если в проекте используются модули к-е нигде не импортируются, то они не будут включены в сборку
        // например lodash, если импортировать только один метод, без sideEffects:true, в сборку попадет вся библиотекан
        sideEffects:     true,
